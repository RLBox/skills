...
description: First-time setup flow for sengclaw-url-to-markdown preferences
---
...
| Project (override) | `.sengclaw-skills/sengclaw-url-to-markdown/EXTEND.md` | Current directory only |

## After Setup

1. Create directory `~/clacky_workspace/.sengclaw-skills/sengclaw-url-to-markdown/` if needed
2. Write EXTEND.md
3. Confirm: "Preferences saved to ~/clacky_workspace/.sengclaw-skills/sengclaw-url-to-markdown/EXTEND.md"
