...
description: First-time setup flow for sengclaw-cover-image preferences
---
...
| Level | Path | Scope |
|-------|------|-------|
| User (default) | `~/clacky_workspace/.sengclaw-skills/sengclaw-cover-image/EXTEND.md` | All directories |
| Project (override) | `.sengclaw-skills/sengclaw-cover-image/EXTEND.md` | Current directory only |

## After Setup

1. Create directory `~/clacky_workspace/.sengclaw-skills/sengclaw-cover-image/` if needed
2. Write EXTEND.md with frontmatter
3. Confirm: "Preferences saved to ~/clacky_workspace/.sengclaw-skills/sengclaw-cover-image/EXTEND.md"
