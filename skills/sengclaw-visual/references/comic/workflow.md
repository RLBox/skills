...
test -f .sengclaw-skills/sengclaw-comic/EXTEND.md && echo "project"
test -f "${XDG_CONFIG_HOME:-$HOME/.config}/sengclaw-skills/sengclaw-comic/EXTEND.md" && echo "xdg"
test -f "$HOME/.sengclaw-skills/sengclaw-comic/EXTEND.md" && echo "user"
```

```powershell
# PowerShell (Windows)
if (Test-Path .sengclaw-skills/sengclaw-comic/EXTEND.md) { "project" }
$xdg = if ($env:XDG_CONFIG_HOME) { $env:XDG_CONFIG_HOME } else { "$HOME/.config" }
if (Test-Path "$xdg/sengclaw-skills/sengclaw-comic/EXTEND.md") { "xdg" }
if (Test-Path "$HOME/.sengclaw-skills/sengclaw-comic/EXTEND.md") { "user" }
```

| Path | Location |
|------|----------|
| `.sengclaw-skills/sengclaw-comic/EXTEND.md` | Project directory |
| `$HOME/.sengclaw-skills/sengclaw-comic/EXTEND.md` | User home |
...
**Strategy A: Using `--ref` parameter** (e.g., sengclaw-image-gen)
