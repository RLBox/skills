...
```bash
/sengclaw-comic content.md --storyboard-only
```
...
```bash
/sengclaw-comic content.md --prompts-only
```
...
```bash
/sengclaw-comic comic/topic-slug/ --images-only
```
...
```bash
# Single page
/sengclaw-comic comic/topic-slug/ --regenerate 3

# Multiple pages
/sengclaw-comic comic/topic-slug/ --regenerate 2,5,8

# Cover page
/sengclaw-comic comic/topic-slug/ --regenerate 0
```
