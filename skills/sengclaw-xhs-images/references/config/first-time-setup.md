...
description: First-time setup flow for sengclaw-xhs-images preferences
---
...
| Project (override) | `.sengclaw-skills/sengclaw-xhs-images/EXTEND.md` | Current directory only |

## After Setup

1. Create directory `~/clacky_workspace/.sengclaw-skills/sengclaw-xhs-images/` if needed
2. Write EXTEND.md with frontmatter
3. Confirm: "Preferences saved to ~/clacky_workspace/.sengclaw-skills/sengclaw-xhs-images/EXTEND.md"
