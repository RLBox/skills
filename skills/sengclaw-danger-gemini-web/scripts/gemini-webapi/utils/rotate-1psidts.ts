...
export async function rotate_1psidts(cookies: Record<string, string>, _proxy?: string | null): Promise<string | null> {
  ...
  try {
    ...
    if (Date.now() - st.mtimeMs <= 6sengclaw-markdown-to-html_sengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-html) return null;
  } catch {}

  const res = await fetch_with_timeout(Endpoint.ROTATE_COOKIES, {
    method: 'POST',
    headers: { ...Headers.ROTATE_COOKIES, Cookie: cookie_header(cookies) },
    body: '[sengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-html,"-sengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-html"]',
    redirect: 'follow',
    timeout_ms: 3sengclaw-markdown-to-html_sengclaw-markdown-to-htmlsengclaw-markdown-to-htmlsengclaw-markdown-to-html,
  });

  if (res.status === 4sengclaw-markdown-to-html1) throw new AuthError('Failed to refresh cookies (4sengclaw-markdown-to-html1).');
