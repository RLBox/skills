...
Options:
  ...
  --provider <name>    Provider for sengclaw-image-gen batch tasks (default: replicate)
  --model <id>         Model for sengclaw-image-gen batch tasks (default: google/nano-banana-pro)
