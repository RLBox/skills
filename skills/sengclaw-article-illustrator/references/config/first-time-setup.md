...
description: First-time setup flow for sengclaw-article-illustrator preferences
---
...
| Project (override) | `.sengclaw-skills/sengclaw-article-illustrator/EXTEND.md` | Current directory only |

## After Setup

1. Create directory `~/clacky_workspace/.sengclaw-skills/sengclaw-article-illustrator/` if needed
2. Write EXTEND.md with frontmatter
3. Confirm: "Preferences saved to ~/clacky_workspace/.sengclaw-skills/sengclaw-article-illustrator/EXTEND.md"
