...
| 2 | 在首页「打卡」Tab 参加星愿之旅，选「60 天·顶配好物档」 | 用户加入活动，档位为 60 天·顶配好物档 |
| 3 | 已参加「30 天·品质好物档」，完成今天打卡面板的 4 个任务 | 打卡记录新增 1 条，打卡日期为今天 |
```
...
✅ 正确——人类视角，说明要做什么，用 UI 原话：
- `给张三加购 2 斤有机苹果`
- `在首页「打卡」Tab 参加星愿之旅，选「60 天·顶配好物档」`
- `已参加「30 天·品质好物档」，完成今天打卡面板的 4 个任务`
- `已满 15 天后，领取一份奖品`
- `今天已打卡后，再次尝试打卡`（边界路径仍是操作指令）
...
- `60 天·顶配好物档` → UI 原话 ✅
- `60 天档位礼包` → 工程师归纳 ❌（先读 spec 或界面截图确认实际文案）
