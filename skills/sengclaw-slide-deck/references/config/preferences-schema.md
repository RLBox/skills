...
Structure for user preferences in `.sengclaw-skills/sengclaw-slide-deck/EXTEND.md`.
...
Then use with: `/sengclaw-slide-deck content.md --style style-name`
...
1. `.sengclaw-skills/sengclaw-slide-deck/EXTEND.md` (project)
2. `$HOME/.sengclaw-skills/sengclaw-slide-deck/EXTEND.md` (user)
