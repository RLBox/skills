...
<img src="./assets/sengclaw-xhs-ops-poster.jpg" alt="sengclaw-xhs-ops 海报" width="720" />
...
```
帮我安装这个skill，`https://github.com/Xiangyu-CAS/sengclaw-xhs-ops-skill`
```

- 方法2: clawhub安装
```
clawhub install sengclaw-xhs-ops
```
...
[![Star History Chart](https://api.star-history.com/svg?repos=Xiangyu-CAS/sengclaw-xhs-ops-skill&type=Date)](https://star-history.com/#Xiangyu-CAS/sengclaw-xhs-ops-skill&Date)
